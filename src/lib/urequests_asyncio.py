...
async def get(url, timeout=10, **kwargs) -> Response:
    try:
...
async def head(url, timeout=10, **kwargs) -> Response:
    try:
...
async def post(url, timeout=10, **kwargs) -> Response:
    try:
...
async def put(url, timeout=10, **kwargs) -> Response:
    try:
...
async def delete(url, timeout=10, **kwargs) -> Response:
    try:
